...
const EXTRA = [
  ...
  },
  {
     ...
     *
     * 3,010 kJ and 81 g protein, both from Grill'd. Carbohydrate 44 g and fat 26.9 g
     * are the aggregator's, which reconcile to 3,120 — within 4% of the real energy.
     *
     * A CAUTIONARY NOTE FOR THE NEXT BUILD-UP. Before Grill'd's figure was known, a
     * component build-up of this burger came to ~3,900 — 30% over — while the same
     * build-up nailed the protein at 81. The aggregator's 2,970 was within 1.3% of the
     * truth and the build-up was the thing that was wrong.
     *
     * The error was all in the small fatty components: 37 g of fat modelled against
     * 26.9 actual, from assuming 20 g of mayo and 30 g of avocado. That is now the
     * third composed item here where building from parts ran high — the RSL parmy by
     * 25% on portion, the Little H burger by 13% on aioli and fry oil, this one by 30%
     * on mayo and avocado. The pattern is specific and worth naming: PROTEIN AND BREAD
     * COMPONENTS BUILD UP ACCURATELY; CONDIMENTS AND SPREADS DO NOT, because a
     * restaurant uses a measured squeeze where an estimate imagines a spoonful.
     *
     * The comparison that matters: the Simply Grill'd already here is 2,510 kJ for
     * 29.2 g protein, 86 kJ per gram. Swapping to this is +500 kJ for +52 g of protein
